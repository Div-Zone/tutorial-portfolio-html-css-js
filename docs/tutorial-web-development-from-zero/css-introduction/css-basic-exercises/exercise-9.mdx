...
- **Título:** Fuente "Poppins", Bold, de 48px y color `#42446E`.
- **Subtítulo:** Fuente "Poppins", Regular, de 32px y color `#666`.
- **Títulos de cards:** Fuente "Poppins", Medium, de 28px y color `#000`.
- **Subtítulos de cards:** Fuente "Poppins", Light, de 18px, color `#666` y espacio entre líneas de 0.
...
- **Enlaces:** Fuente "Poppins", Bold, de 48px y color `#42446E`.
